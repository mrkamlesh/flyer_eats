...
class PickupOrderHistoryBloc extends Bloc<PickupOrderHistoryEvent, PickupOrderHistoryState> {
  ...
  Stream<PickupOrderHistoryState> mapOnLoadMoreToState(String token) async* {
    ...
    try {
      List<PickupOrder> list = await repository.getPickupOrderHistory(token, "pickup_drop", state.page);
