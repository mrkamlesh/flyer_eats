...
class CouponState {
  ...
  final List<Voucher> couponList;

  CouponState copyWith(
      {String couponTyped, Voucher voucher, List<Voucher> couponList}) {
    return CouponState(
...
class InitialCouponState extends CouponState {
  InitialCouponState() : super(couponTyped: "", voucher: null, couponList: []);
}
...
class LoadingCouponList extends CouponState {
  LoadingCouponList(
      {String couponTyped, Voucher voucher, List<Voucher> couponList})
      : super(
            couponTyped: couponTyped, voucher: voucher, couponList: couponList);
}
